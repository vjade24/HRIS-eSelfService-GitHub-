 ...
 ******************************************************************
 ******************************************************************
 * Purpose      : Back-end code for override for eSelfService
...
{
    public class rSSAHRDoctorController : Controller
    {
            ...
            , string p_view_type)
        {
            try
            {
                ...
                var filteredGrid = db_ats.sp_dtr_override_list(p_year, p_month, p_empl_id, p_view_type, p_dept_code, user_id);
