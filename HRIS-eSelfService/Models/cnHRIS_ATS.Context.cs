...
namespace HRIS_eSelfService.Models
{
    ...
    public partial class HRIS_ATSEntities : DbContext
    {
        ...
        public virtual DbSet<travelOrder_pa_checklist_tbl> travelOrder_pa_checklist_tbl { get; set; }
        ...
        public virtual ObjectResult<sp_generate_travel_order_actioned_pa_rep_Result> sp_generate_travel_order_actioned_pa_rep(string par_period_from, string par_period_to, string par_dept_code, string par_type, string par_user_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_generate_travel_order_actioned_pa_rep_Result>("sp_generate_travel_order_actioned_pa_rep", par_period_fromParameter, par_period_toParameter, par_dept_codeParameter, par_typeParameter, par_user_idParameter);
        }
