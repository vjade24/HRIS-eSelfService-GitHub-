            ...
            h.post("../cSSTimeSchedule/SelectTimeSched", {
                ...
                if (d.data.message == "success") {
                    ...
                    if (s.add_days_orig_edit > 0) {
                        var counter = row_id + 1;

                        for (var x = 0; x < s.add_days_orig_edit; x++) {
                            ...
                            h.post("../cSSTimeSchedule/CheckExist",
                                {
                                    ...
                                    if (d.data.message == "true") {
                                        ...
                                        //arr_datalist_grid2_data_save = s.datalistgrid2
            ...
            if (s.txtb_nbr_days == 0) {                                                                 // NO. OF DAYS IS EQUAL TO 0
                ...
                if (s.flag == "insert") {
                    ...
                    if (s.txtb_nbr_days <= counter) {
                        ...
                        var day = next_day;
						console.log(moment(day).format("YYYY-MM-DD").toString())
                        for (var x = (s.temp_row + 1); x <= next_rows; x++) {
                            var data = [];
                            if (x == next_rows) {
                                data = {
            ...
            h.post("../cSSTimeSchedule/SelectTimeSched", {
                ...
                if (d.data.message == "success") {
                    ...
                    if (s.add_days_orig_edit > 0) {
                        ...
                        console.log(arr_datalist_grid2_data)
