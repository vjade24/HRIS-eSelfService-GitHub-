 ...
 *                          
*/
ng_selfService_App.controller("rSSDTRDiscrepancies_ctrlr", function ($scope, $compile, $http, $filter) {
    var s = $scope;
    var h = $http;
    s.year = [];
    s.ddl_month = [];
    ...
    function init() {
        ...
        h.post("../rSSDTRDiscrepancies/InitializeData").then(function (d) {
    ...
    //            h.post("../rSSDTRDiscrepancies/GenerateDTREmployee", {
    ...
    s.btn_print = function () {
        ...
        if (isdataValidate()) {
            ...
            h.post("../rSSDTRDiscrepancies/RetriveData",
                {
                    par_year: $("#ddl_payroll_year").val()
                    , par_month: $("#ddl_month").val()
                    , par_empl_id: $("#txtb_empl_id2").val()
                    ...
                    if (d.data.sp_report.length == 0) {
                        ...
                        ReportPath = "~/Reports/cryDTRDiscrepanciesReport/cryDTRDiscrepanciesReport.rpt"
                        sp = "sp_dtr_descri_rep,par_year," + $("#ddl_payroll_year").val() + ",par_month," + $("#ddl_month").val() + ",par_empl_id," + $("#txtb_empl_id2").val() + ",par_view_type," + $("#ddl_viewtype").val() + ",par_department_code," + $("#ddl_dept").val() + ",par_user_id," + d.data.session_user_id
    ...
    s.ddl_dept_chane = function () {
        try {
            h.post("../rSSDTRDiscrepancies/DepartmentFilter", {
