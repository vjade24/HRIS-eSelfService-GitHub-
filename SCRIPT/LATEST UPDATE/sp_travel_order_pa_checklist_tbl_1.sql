-- EXEC sp_travel_order_pa_checklist_tbl_1 '','','','','U10058'


ALTER PROCEDURE sp_travel_order_pa_checklist_tbl_1                                      
...
DECLARE @par_period_to_covered_sp DATE                                      
 ...
 WHERE 
 --(CONVERT(DATE,MN.check_approved_dttm) BETWEEN CONVERT(DATE,@par_period_from_covered_sp) AND  CONVERT(DATE,@par_period_to_covered_sp))                                        
 -- AND 
  MN.approval_status IN ('1','2') 
  AND 
  MN.approved_status = 'N'
